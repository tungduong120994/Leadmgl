...
namespace Lead_MGTModel.EntityModel
{
    ...
    public partial class GW_Tranfer_CRM
    {
        ...
        public Nullable<short> distributed { get; set; }
        public Nullable<int> distributed_by_user_id { get; set; }
        public Nullable<System.DateTime> distributed_on_date { get; set; }
        public string email { get; set; }
        public Nullable<short> exists { get; set; }
        public string i2b_status { get; set; }
        public Nullable<System.DateTime> identification_date { get; set; }
        public string identification_place { get; set; }
        ...
        public Nullable<double> upl_interest_origin { get; set; }
    }
}
